...
class OneTimeTransaction extends BaseTransaction implements TransactionContract
{
     ...
     * @param $plan
     */
    protected function __construct($transactionRef, $amount, $email, $tp_data, $plan)
    {
...
//        $this->transactionResource = $transactionResource;
     ...
     * @return static
     */
    public static function make($amount, $email, $tp_data, $plan)
    {
        return new static(self::generateTransactionRef(), $amount, $email, $tp_data, $plan);
    }
    ...
    public function _requestPayload()
    {
        $payload = [
            ...
            'email'     => $this->email,
            'metadata' => json_encode($this->tp_data)
        ];
